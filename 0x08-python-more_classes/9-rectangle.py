...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Get the bigger rectangle based on area

        Args:
            rect_1 (Rectangle): first rectangle to compare.
            rect_2 (Rectangle): the rectangle to compare with.

        Raises:
            TypeError: rect_1 must be an instance of Rectangle
            TypeError: rect_2 must be an instances of Rectangle
    ...
    def square(cls, size=0):
        ...
        Args:
            size (int): Size of of the quare sides.

        Return:
            a Rectangle instances with equal sizes.
        """
